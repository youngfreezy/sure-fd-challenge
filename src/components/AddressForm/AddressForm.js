...
function AddressForm({
  ...
  return (
    <div className="address-form">
      <FormControl>
        <InputField label="Address" id="line_1" onChange={onChange} required={true} />
        {displayErrorMessages("line_1", formState)}
      </FormControl>
      {}
      <FormControl>
        <InputField label="Line 2" id="line_2" onChange={onChange} required={false} />
        {displayErrorMessages("line_2", formState)}
      </FormControl>
      <FormControl>
        <InputField label="City" id="city" onChange={onChange} required={true} />
        {displayErrorMessages("city", formState)}
      </FormControl>
      <FormControl>
        <InputField label="Region" id="region" onChange={onChange} required={true} />
      ...
      <FormControl>
        ...
        <InputField label="Postal" id="postal" onChange={onChange} required={true} />
